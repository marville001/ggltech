			...
			<div className="mx-auto max-w-[1240px] py-8">
				<div className="flex justify-between items-start flex-col gap-10 px-2 md:flex-row">
					<ul className="flex flex-col gap-3">
						<li>
							<Link className="text-white font-urbanist leading[26px] text-[22px]" href="/blog">Blog</Link>
						</li>
						<li>
							<Link className="text-white font-urbanist leading[26px] text-[22px]" href="/our-team">Our Team</Link>
						</li>
						<li>
							<Link className="text-white font-urbanist leading[26px] text-[22px]" href="/contact-us">Contact Us</Link>
						</li>
						<li>
							<Link className="text-white font-urbanist leading[26px] text-[22px]" href="/faqs">FAQs</Link>
						</li>
						<li>
							<Link className="text-white font-urbanist leading[26px] text-[22px]" href="/about-us">About GGL</Link>
						</li>
					</ul>
